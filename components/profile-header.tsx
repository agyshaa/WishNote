                ...
                <div className="flex-1 text-center sm:text-left">
                    ...
                    <div className="flex items-center justify-center sm:justify-start gap-6 mt-4">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">{t("profile.lists")}</p>
                        </div>
                        <div>
                            <p className="text-2xl font-bold text-foreground">{totalItems}</p>
                            <p className="text-xs text-muted-foreground">{t("profile.items")}</p>
                        </div>
                        <div>
                            <p className="text-2xl font-bold text-secondary">₴{totalValue.toFixed(0)}</p>
                            <p className="text-xs text-muted-foreground">{t("profile.totalValue")}</p>
                        </div>
                    </div>
                </div>
